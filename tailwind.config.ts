  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow": "0 0 25px -5px hsl(var(--primary) / 0.2)",
        "glow-lg": "0 0 40px -8px hsl(var(--primary) / 0.25)",
        "card-hover": "0 20px 40px -12px hsl(var(--foreground) / 0.1)",
        "premium": "0 8px 30px -10px hsl(var(--primary) / 0.2), 0 0 1px hsl(var(--primary) / 0.1)",
      },
    },
  },
