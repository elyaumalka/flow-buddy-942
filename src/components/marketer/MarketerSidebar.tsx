        ...
        {!collapsed && (
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-sidebar-foreground/50 font-medium">פאנל משווק</p>
            </div>
          </div>
        )}
        {collapsed && (
            ...
            <SidebarMenu>
              {menuItems.map((item) => (
                <SidebarMenuItem key={item.url}>
                  ...
                  >
                    <NavLink to={item.url} end={item.url === "/marketer"} activeClassName="text-sidebar-accent-foreground font-bold">
